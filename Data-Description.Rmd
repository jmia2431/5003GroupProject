...
Dependent variable: binary categorical variable indicating rental type. this variable contain two outcome which is commerica where there's always available, entire unit, multiple listings by host and  occasional where there's limited availability, host-occupied, fewer listings. Yet this metric it not in the raw data, we will construct it using availability_365, minimum_nights, host_total_listings_count and instant_bookable.
